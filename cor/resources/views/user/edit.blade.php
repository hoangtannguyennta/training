        ...
        <div class="form">
            ...
            <div class="form-bottom">
                <form action="{{ route('user.update',$users->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <input type="text" class="input" id="fname" name="name" value="{{ $users->name }}" placeholder="Nhập tên">
                    @error('name')
                    ...
                    <input type="email" class="input" id="lname" name="email" value="{{ $users->email  }}" placeholder="Nhập email">
                    @error('email')
                        <div class="invalid-form">
                            <strong>{{ $message }}</strong>
                        </div>
